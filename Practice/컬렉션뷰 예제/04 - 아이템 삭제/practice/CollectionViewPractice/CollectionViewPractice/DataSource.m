...
{
    NSMutableIndexSet *selectedIndexSets = [[NSMutableIndexSet alloc]init];
    
    for (NSIndexPath *indexPath in indexPaths)
    {
        [selectedIndexSets addIndex:indexPath.item];
    }
    
    
    [self.parkDataArray removeObjectsAtIndexes:selectedIndexSets];
}
