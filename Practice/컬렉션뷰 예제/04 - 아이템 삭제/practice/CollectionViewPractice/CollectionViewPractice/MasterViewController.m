...
{
    NSArray *selectedArray = [self.mainCollectionView indexPathsForSelectedItems];
    
    [self.source deleteItemsAtIndexPaths:selectedArray];
    
    [self.mainCollectionView deleteItemsAtIndexPaths:selectedArray];
}
