...
- (IBAction)tapAddButton:(UIBarButtonItem *)sender
{
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"인덱스가 필요함"
                                                                   message:nil
    ...
    UIAlertAction *okAction = [UIAlertAction actionWithTitle:@"확인"
                                                     ...
                                                     handler:^(UIAlertAction * _Nonnull action) {
                                                         ...
                                                         UITextField *textField = alert.textFields.firstObject;
                                                             ...
                                                             NSIndexPath *addIndexPath = [NSIndexPath indexPathForItem:textField.text.integerValue inSection:0];
                                                         [self.source addItemAtIndexPath:addIndexPath];
                                                         
                                                         [self.mainCollectionView insertItemsAtIndexPaths:@[addIndexPath]];
    ...
    [alert addTextFieldWithConfigurationHandler:^(UITextField * _Nonnull textField) {
        textField.placeholder = @"인덱스 넘버를 입력해 주세요";
    }];
