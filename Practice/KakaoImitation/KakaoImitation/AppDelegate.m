...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //UITabBarController *tabBar = [sto instantiateInitialViewController];
    ...
    UITabBarItem *item1 = [[UITabBarItem alloc] initWithTitle:@"처음"
                                                              image:[UIImage imageNamed:@"human"]
                                                      selectedImage:[UIImage imageNamed:@"human"]];
