...
class MasterViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let backgroungImageView = UIImageView(image: UIImage(named: "background.jpg"))
        
        backgroungImageView.contentMode = UIViewContentMode.scaleAspectFill
        backgroungImageView.frame = self.tableView.frame
        
        self.tableView.backgroundView = backgroungImageView
    }
